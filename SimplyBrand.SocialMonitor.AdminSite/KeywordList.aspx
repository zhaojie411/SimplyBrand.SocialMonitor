        ...
        <div class="row-fluid">
            <div class="box span12">
                <div class="box-header well">
                    ...
                    <div class="box-icon">
                        <a href="/UserManage.aspx" class="btn btn-setting btn-round" title="返回"><i class="icon icon-undo"></i></a>
                    </div>
                </div>
                        ...
                        try {
                            ...
                            if (json.issucc == false) {
                                ...
                                $.each(json.data.items, function (index, item) {
                                    ...
                                    html += '<td class="center"><a class="btn btn-success" href="KeywordListDetail.aspx?q=' + userid + '&keyid=' + item.id + '"><i class="icon-zoom-in icon-white"></i>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;';
