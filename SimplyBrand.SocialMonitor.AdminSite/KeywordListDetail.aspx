        ...
        <div class="row-fluid">
            <div class="box span12">
                <div class="box-header well">
                    ...
                    <div class="box-icon">
                        <a id="goback" href="#" class="btn btn-setting btn-round" title="返回"><i class="icon icon-undo"></i></a>
                    </div>
                </div>
    ...
    <div class="sortable ui-sortable modal hide fade" id="updateMemberForm" style="display: none;">
        <div class="box span12">
            <div class="box-header well" data-original-title="">
                <h2 id="htitle"></h2>
                <div class="box-icon">
                    <a id="back" href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                var q = getUrlParam("q");
                $("#goback").attr("href", "/KeywordList.aspx?q=" + q);
                if (familyid.match("^\d+$")) {
