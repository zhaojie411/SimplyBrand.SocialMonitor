...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        //   $('#txtdateStart').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'yy-mm-dd' });
        ...
        $(document).ready(function () {
            ...
            $("#sb_search").click(function () {
                drawPieChart(getcbkeywordfamily(), getcbplatsource(), true);
                drawLineChart(getcbkeywordfamily(), getcbplatsource(), true, getcbemotionvalues());
                //drawCloudWord();
            });
        });
    </script>
